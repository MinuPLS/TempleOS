...
export const LEGACY_DIVINE_MANAGER_ADDRESS = '0x7EE5476ae357b02F3F61Ba0d8369945d3615E0de' as const;
export const DIVINE_MANAGER_ADDRESSES = [DIVINE_MANAGER_ADDRESS, LEGACY_DIVINE_MANAGER_ADDRESS] as const;
export const AOT_RELAYER_ADDRESS = '0x9E39d3c00A49AA244A62740f7209D4C133b5780c' as const;
export const LEGACY_AOT_RELAYER_ADDRESS = '0x91F76e6C9d9cA8aC5eFf08f08c3403A392BdDd13' as const;
export const AOT_RELAYER_ADDRESSES = [AOT_RELAYER_ADDRESS, LEGACY_AOT_RELAYER_ADDRESS] as const;
...
export const CONTRACT_ADDRESSES = {
  ...
  legacyDivineManager: LEGACY_DIVINE_MANAGER_ADDRESS,
  aotRelayer: AOT_RELAYER_ADDRESS,
  legacyAotRelayer: LEGACY_AOT_RELAYER_ADDRESS,
